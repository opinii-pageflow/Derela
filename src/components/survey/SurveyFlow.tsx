          ...
          >
            {currentStep === 0 && (
              <div className="text-center space-y-8 py-4">
                ...
                <Button 
                  onClick={next} 
                  className="bg-rose-400 hover:bg-rose-500 text-white rounded-full px-14 h-16 text-lg font-medium tracking-wide transition-all hover:scale-105 shadow-xl shadow-rose-100 border-none"
                >
                  Iniciar
                </Button>
              </div>
