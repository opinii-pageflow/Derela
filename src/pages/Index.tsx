...
const Index = () => {
  return (
    <div className="min-h-screen bg-[#FFFDFB] selection:bg-rose-100 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-rose-50/50 rounded-full blur-3xl -z-10" />
      ...
      <header className="pt-16 pb-8 text-center flex flex-col items-center">
        ...
        <div className="space-y-1">
          <div className="inline-block px-3 py-0.5 rounded-full bg-slate-900 text-white text-[10px] font-bold tracking-[0.2em] uppercase mb-2">
            Experience Research
          </div>
          <h1 className="text-4xl font-serif text-slate-900 tracking-tighter lowercase italic">derela</h1>
        </div>
      </header>
      ...
      <footer className="py-16 flex flex-col items-center gap-6">
        ...
        <p className="text-slate-400 text-xs font-light tracking-wide uppercase">Estilo que expressa sua essência</p>
        <MadeWithDyad />
      </footer>
    </div>
  );
